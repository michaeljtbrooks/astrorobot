...
def main():
    ...
    #-- 5 --
    # [ aa  :=  horizon py of raDec at hour angle h
...
def checkArgs():
    """Process all command line arguments.
      ...
      [ if sys.argv[1:] is a valid set of command line arguments ->
          ...
          celestial py as a sidereal.RADec instance,
    ...
    #-- 2 --
    # [ if rawRADec is a valid set of equatorial py ->
    #     raDec  :=  those py as a sidereal.RADec instance
    #   else ->
    #     sys.stderr  +:=  error message
    #     stop execution ]
...
def checkRADec ( rawRADec ):
    """Check and convert a pair of equatorial py.

      [ rawRADec is a string ->
          if rawRADec is a valid set of equatorial py ->
            return those py as a sidereal.RADec instance
          else ->
            sys.stderr  +:=  error message
            stop execution ]
    """

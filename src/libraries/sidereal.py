...
# - - -   A l t A z . _ _ i n i t _ _
    ...
    def __init__ ( self, alt, az ):
        """Constructor for AltAz, horizon py.
...
class RADec:
    """Represents a celestial location in equatorial py.
...
# - - -   R A D e c . a l t A z
    ...
    def altAz ( self, h, lat ):
        """Convert equatorial to horizon py.
          ...
          [ (h is an object's hour angle in radians) and
            (lat is the observer's latitude in radians) ->
              ...
              in horizon py as an AltAz instance ]
        """
        #-- 1 --
